package com.lhever.common.core.support.watch;
 ...
 * </p>
 *
 * @author lihong10 2020/9/21 17:28
 * @version v1.0
 * @modificationHistory=========================逻辑或功能性重大变更记录
 * @modify by user: {修改人} 2020/9/21 17:28
...
public class ThreadDeathWatcher {
    ...
    private static void schedule(Thread thread, Runnable task, boolean isWatch) {
        ...
        if (started.compareAndSet(false, true)) {
            final Thread watcherThread = new Thread(null,watcher, "threadDeathWatcher");
