...
public interface GroupMapper {
    ...
    @Insert({
        ...
        "create_id, member_ids, ",
        "status, create_time, ",
        "update_time)",
        "values (#{id,jdbcType=VARCHAR}, #{groupName,jdbcType=VARCHAR}, ",
        "#{createId,jdbcType=VARCHAR}, #{memberIds,jdbcType=VARCHAR}, ",
    ...
    @Results({
        ...
        @Result(column="member_ids", property="memberIds", jdbcType=JdbcType.VARCHAR),
    ...
    @Select({
        "select",
        "id, group_name, create_id, member_ids, status, create_time, update_time",
        "from im_group",
        "where id = #{id,jdbcType=VARCHAR}"
    })
    @Results({
