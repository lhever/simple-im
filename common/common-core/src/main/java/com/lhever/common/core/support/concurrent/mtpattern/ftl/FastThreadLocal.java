...
import com.lhever.common.core.converter.bytes.UnsafeAccess;
 ...
 * </p>
 *
 * @author lihong10 2020/11/4 21:32
 * @version v1.0
 * @modificationHistory=========================逻辑或功能性重大变更记录
 * @modify by user: {修改人} 2020/11/4 21:32
...
public class FastThreadLocal<V> {
    ...
    public static void throwException(Throwable t) {
        if (UnsafeAccess.isAvailable()) {
            UnsafeAccess.theUnsafe.throwException(t);
        } else {
            FastThreadLocal.<RuntimeException>throwException0(t);
        }
    }
