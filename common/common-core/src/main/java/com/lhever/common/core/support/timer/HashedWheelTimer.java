...
import com.lhever.common.core.support.leak.ResourceLeakDetector;
import com.lhever.common.core.support.leak.ResourceLeakDetectorFactory;
import com.lhever.common.core.support.leak.ResourceLeakTracker;
...
public class HashedWheelTimer implements Timer {
    ...
    static {
        ...
        unsafe = (unsafe != null) ? unsafe : AccessController.doPrivileged(new PrivilegedAction<Object>() {
            @Override
            public Object run() {
    ...
    private static void reportTooManyInstances() {
        if (logger.isErrorEnabled()) {
            String resourceType = ObjectUtils.simpleClassName(HashedWheelTimer.class);
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        public String toString() {
            ...
            StringBuilder buf = new StringBuilder(192)
                    .append(ObjectUtils.simpleClassName(this))
                    .append('(')
                    .append("deadline: ");
            if (remaining > 0) {
